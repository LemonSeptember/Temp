...
namespace BLECode
{
    public class BluetoothLECode
    {
        ...
        {
            ValueChanged(MsgType.NotifyTxt, "发现设备: " + "Name: " + args.Name + " ID: " + args.Id);
            BLEInfoEvent(args.Name, args.Id);
        ...
        public async Task Write(byte[] data)
        {
            ...
            {
                //MessageBox.Show("Write", "", MessageBoxButtons.OK);
                _ = CurrentWriteCharacteristic.WriteValueAsync(CryptographicBuffer.CreateFromByteArray(data), GattWriteOption.WriteWithResponse);
            }
        }
