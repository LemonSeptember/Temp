...
namespace XianFeng.Railway.Replay
{
        ...
        public string DisplayValue(xfCoordFormat format)
        {
            switch (format)
            {
                ...
                case xfCoordFormat.Seconds:
                    return string.Format("{1}°{2}′{3}″{0} ", Zone, Degree, Minute, Second * 60 / 10000.0f);
                default:
    ...
    public class AViewData
    {
        /// <summary>
        /// 大门前沿
        /// </summary>
        public short Gate0Head { get; set; }

        /// <summary>
        /// 大门后沿
        /// </summary>
        public short Gate0Tail { get; set; }

        /// <summary>
        /// 小门1前沿//螺孔
        /// </summary>
        public short Gate1Head { get; set; }

        /// <summary>
        /// 小门1后沿
        /// </summary>
        public short Gate1Tail { get; set; }

        /// <summary>
        /// 小门2前沿//0°轨底
        /// </summary>
        public short Gate2Head { get; set; }

        /// <summary>
        /// 小门2后沿
        /// </summary>
        public short Gate2Tail { get; set; }
    }

    /// <summary>
    /// 底波模式
    /// </summary>
    public enum xfBottomWaveMode
    {
        /// <summary>
        /// 0-底波
        /// </summary>
